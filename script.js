document.addEventListener('DOMContentLoaded', function() {
    ...
    function addApplianceToDOM(appliance) {
        ...
        applianceElement.innerHTML = `
            ...
            <div class="appliance-details">
                ...
                <div class="appliance-watts">${appliance.watts}W × ${appliance.hours} hrs/day</div>
            </div>
    ...
    document.getElementById('calculate-appliance').addEventListener('click', function() {
        ...
        // Convert watts to kWh (1000 watts = 1 kW)
    ...
    function calculateAndDisplay(kwh, rate, days, taxRate = 0) {
        ...
        document.getElementById('hourly-cost').textContent = `$${(hourlyCost + (taxAmount / (days * 24))).toFixed(3)}`;
    ...
    const energyTips = [
        ...
        "Seal leaks around doors and windows to prevent cooled/heated air from escaping.",
